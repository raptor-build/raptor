...
struct PercentageTests {
    ...
    func value(decimals: Int, percent: Percentage, expected: Double) {
    ...
    @Test("Rounded value", arguments: [
        ...
        (Percentage(25.5), 26)])
    func roundedValue(percent: Percentage, expected: Int) {
    ...
    func subtract(minuend: Percentage, subtrahend: Percentage, expected: Double) {
    ...
    func add(firstAddend: Percentage, secondAddend: Percentage, expected: Double) {
    ...
    func multiply(factor: Double, percent: Percentage, expected: Double) {
    ...
    @Test("Comparable operator", arguments: [
        ...
        (Percentage(20), Percentage(-19), false)])
    func comparable(lhs: Percentage, rhs: Percentage, expected: Bool) {

...
struct StringSplitAndTrimTests {
    ...
    func simple_cases_become_a_one_element_array(string: String) {
        #expect(string.splitAndTrim() == [string])
    }

    @Test("Empty String Results in Empty Array")
    func empty_string_becomes_empty_array() {
        #expect("".splitAndTrim() == [])
    }
    ...
    func comma_separated_without_spaces(instance: Instance) {
    ...
    func comma_separated_followed_by_spaces(instance: Instance) {
        #expect(instance.input.splitAndTrim() == instance.expected)
    }
    ...
    func comma_separated_prepended_by_spaces(instance: Instance) {
        #expect(instance.input.splitAndTrim() == instance.expected)
    }
    ...
    func drops_all_empty_strings_from_output(instance: Instance) {
        #expect(instance.input.splitAndTrim() == instance.expected)
    }
    ...
    func drops_whitespace_strings_before_and_after_strings_from_output(instance: Instance) {
        #expect(instance.input.splitAndTrim() == instance.expected)
    }
    ...
    func does_not_drop_whitespace_strings_from_output(instance: Instance) {
        #expect(instance.input.splitAndTrim() == instance.expected)
    }
}

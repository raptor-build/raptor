...
struct StringSlugTests {
    ...
    func does_not_change_simple_cases(string: String) throws {
    ...
    func converts_title_case_to_lowercase(string: String) throws {
    ...
    func transliterates_characters_in_non_latin_scripts(instance: Instance) {
    ...
    func strips_diacritics(instance: Instance) {
        #expect(instance.input.convertedToSlug() == instance.expected)
    }
    ...
    func strips_punctuation_from_ends_of_string(instance: Instance) {
        #expect(instance.input.convertedToSlug() == instance.expected)
    }
    ...
    func removes_punctuation_between_words(instance: Instance) {
        #expect(instance.input.convertedToSlug() == instance.expected)
    }
    ...
    func removes_emoji_between_words(instance: Instance) {
        #expect(instance.input.convertedToSlug() == instance.expected)
    }
    ...
    func replaces_capitalized_characters_with_dash_then_lowercase(instance: Instance) {
        #expect(instance.input.convertedToSlug() == instance.expected)
    }
    ...
    func replaces_common_math_operators_with_dash(instance: Instance) {
        #expect(instance.input.convertedToSlug() == instance.expected)
    }
    ...
    func respects_existing_dashes_when_converting_to_lowercase(instance: Instance) {
        #expect(instance.input.convertedToSlug() == instance.expected)
    }
    ...
    func reaplces_underscores_with_dashes(instance: Instance) {
        #expect(instance.input.convertedToSlug() == instance.expected)
    }
    ...
    func concatenates_lowercase_words_with_dashes(string: String) {
    ...
    func double_dash_for_dash_then_uppercase(instance: Instance) {
        #expect(instance.input.convertedToSlug() == instance.expected)
    }
    ...
    func concatenatesa_lowercase_words_with_dashes(instance: Instance) {
        #expect(instance.input.convertedToSlug() == instance.expected)
    }
    ...
    func acronyms_are_lowercased_and_dash_separated(instance: Instance) {
        #expect(instance.input.convertedToSlug() == instance.expected)
    }

...
struct ArrayContainsLocationTests {
    ...
    func testIfArrayContainsRandomlyChosenPath() {
        // Given
        let testPaths = [
        ...
        // When
        // Count how many of the randomly chosen locations have paths contained in testPaths
        let actualNumberOfPaths = randomLocations.filter { testPaths.contains($0.path) }.count

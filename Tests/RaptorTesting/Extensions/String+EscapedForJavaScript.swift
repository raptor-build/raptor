...
struct StringEscapedForJavaScriptTests {
    ...
    func replaces_single_quotes_with_escaped_quotes(instance: Instance) {
    ...
    func replaces_quotation_marks_with_html_escaped_quot_sequence(instance: Instance) {
        #expect(instance.input.escapedForJavascript() == instance.expected)
    }
    ...
    func combined_examples(instance: Instance) {
        #expect(instance.input.escapedForJavascript() == instance.expected)
    }

...
struct StringAbsoluteLinksTests {
    ...
    func makingAbsoluteLinks_forSimplePaths() {
        // Given
        let html = """
    ...
    func makingAbsoluteLinks_forMixedAbsoluteAndRelativePaths() {
        // Given
        let html = """
        <img src="/images/pic1.jpg">
    ...
    func makingAbsoluteLinks_forPathsThatDontStartWithASlash() {
        // Given
        let html = """
        <img src="pic1.jpg">
        <a href="about">About Us</a>
    ...
    func makingAbsoluteLinks_forURLsWithQueriesAndFragments() {
        // Note: (%3F is '?', %23 is '#')
        // Given
        let html = """
    ...
    func makingAbsoluteLinks_forAnInvalidBaseURL() {
        // Given
    ...
    func makingAbsoluteLinks_forEmptyHTML() {
        // Given
        let html = ""
        // When
        let result = html.makingAbsoluteLinks(relativeTo: baseURL)
    ...
    func makingAbsoluteLinks_forHTMLWithoutLinksOrImages() {
        // Given
    ...
    func makingAbsoluteLinks_forMissingEndQuotesInHTMLPath() {
        // Note: (%3E is '>')
        // Given

...
struct StringCSStoJSTests {
    ...
    func convertingCSSNamesToJS_forZeroHyphenNames() {
        // Given
        let cssName1 = "color"
        let cssName2 = "margin"
        // When
    ...
    func convertingCSSNamesToJS_forSingleHyphenNames() {
        // Given
    ...
    func convertingCSSNamesToJS_forMultipleHyphenNames() {
        // Given
    ...
    func convertingCSSNamesToJS_forPreOrPostHyphenatedNames() {
        // Given
        let cssName1 = "--background-color"
        let cssName2 = "--font-size"
        let cssName3 = "-writing-mode-"
    ...
    func convertingCSSNamesToJS_forNamesWithNumbers() {
        // Given
    ...
    func convertingCSSNamesToJS_forUppercasedNames() {
        // Given
    ...
    func convertingCSSNamesToJS_forMixedCaseNames() {
        // Given
        let cssName1 = "background-Color"
    ...
    func convertingCSSNamesToJS_forNamesWithSpecialCharacters() {
        // Given
    ...
    func convertingCSSNamesToJS_forAnEmptyString() {
        // Given
        let cssName = ""
        // When

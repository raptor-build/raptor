...
struct StringKebabCasedTests {
    ...
    func does_not_change_simple_cases(string: String) {
    ...
    func converts_whitespaces_to_dashes(string: String) {
    ...
    func converts_capitals_to_lowercase(string: String) {
    ...
    func concatenates_words_with_dashes(string: String) {
    ...
    func converts_camelCase_to_words_separated_by_dashes(instance: Instance) {
    ...
    func converts_to_lowercase_leaving_dashes(instance: Instance) {
        #expect(instance.input.kebabCased() == instance.expected)
    }
    ...
    func complex_examples(instance: Instance) {
        #expect(instance.input.kebabCased() == instance.expected)
    }

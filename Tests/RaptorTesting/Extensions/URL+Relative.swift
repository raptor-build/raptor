...
struct URLRelativeTests {
    ...
    func relativePath_forURLWithAMatchingBasePath() {
        // Given
    ...
    func relativePath_forURLWithNoCommonBase() {
        // Given
    ...
    func relativePath_forAnIdenticalURL() {
        // Given
        let fullURL = URL(string: "https://example.com/folder/file.html")!
    ...
    func relativePath_forBaseURLWithoutTrailingSlash() {
        // Given
        let fullURL = URL(string: "https://example.com/folder/subfolder/file.html")!
        let baseURL = URL(string: "https://example.com/folder")!
        // When
    ...
    func relativePath_forBaseURLWithTrailingSlash() {
        // Given
        let fullURL = URL(string: "https://example.com/folder/subfolder/file.html")!
        let baseURL = URL(string: "https://example.com/folder/")!
        // When
    ...
    func relativePath_forURLsWithNoScheme() {
        // Given
    ...
    func relativePath_forURLsWithDifferentSchemes() {
        // Given
    ...
    func relativePath_forInvalidBaseURLs() {
        // Given
    ...
    func relativePath_whenBothURLsAreIncomplete() {
        // Given
    ...
    func relativePath_forABlankURL() {
        // Given
    ...
    func relativePath_forABlankBaseURL() {
        // Given
        let fullURL = URL(string: "https://example.com/folder/file.html")!

...
struct StringStrippingTagsTests {
    ...
    func strippingTags_fromStringWithOneHTMLTag() {
        // Given
    ...
    func strippingTags_fromStringWithMultipleTags() {
        // Given
    ...
    func strippingTags_fromStringWithNestedTags() {
        // Given
    ...
    func strippingTags_fromStringWithSelfClosingTags() {
        // Given
    ...
    func strippingTags_fromStringWithUnclosedTags() {
        // Given
    ...
    func strippingTags_fromStringWithTagsWithAttributes() {
        // Given
    ...
    func strippingTags_fromStringWithoutHTMLTags() {
        // Given
    ...
    func strippingTags_fromEmptyString() {
        // Given
        let input = ""
        // When
        let result = input.strippingTags()
    ...
    func strippingTags_fromStringWithOnlyHTMLTags() {
        // Given
    ...
    func strippingTags_fromStringWithSpecialCharactersInTags() {
        // Given
    ...
    func strippingTags_fromStringWithInvalidHTML() {
        // Given
    ...
    func strippingTags_fromMultiLineStringWithTags() {
    ...
    func strippingTags_fromStringWithScriptOrStyleTags() {
        // Given
        let input = """

...
/// The command responsible for creating new Raptor sites.
/// This clones the starter repository from GitHub.
struct NewCommand: ParsableCommand {
    static let configuration = CommandConfiguration(
        commandName: "new",
        abstract: "Creates a new Raptor site in a named folder."
    )

    @Option(name: .shortAndLong, help: "The Git repository to clone.")
    var template: String = "https://github.com/raptor-build/raptor-starter"
    ...
    func run() throws {
        ...
        print("⚙️  Creating a new Raptor site in '\(name)'...")
        ...
        if result.error.contains("fatal") {
            ...
            // for the RaptorStarter repo to avoid confusion.

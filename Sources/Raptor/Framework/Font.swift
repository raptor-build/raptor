...
public struct Font: Hashable, Equatable, Sendable {
    ...
    public enum FontSize: Hashable, Sendable {
        /// Absolute base size in pixels (CSS px / Apple pt equivalent).
        case fixed(Double)

        /// Multiplier applied relative to the base font size.
        case scaled(Double)
    ...
    public static func system(
        ...
        Font(name: nil, style: style, size: .fixed(size), weight: weight)
    }
    ...
    public static func custom(
        ...
        Font(name: name, style: style, size: .fixed(size), weight: weight)
    }

...
private struct ClassInlineModifier: InlineContentModifier {
...
public extension InlineContent {
    ...
    func `class`(_ className: String) -> some InlineContent {
    ...
    func `class`(_ newClasses: String?...) -> some InlineContent {

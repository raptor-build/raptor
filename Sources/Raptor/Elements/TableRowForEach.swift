...
public struct TableRowForEach<Data: Sequence, Content: TableContent>: TableContent {
    ...
    public init(_ data: Data, @TableContentBuilder content: @escaping (Data.Element) -> Content) {
        self.data = data

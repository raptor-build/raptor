...
public struct Quote<Caption: InlineContent, Content: HTML>: HTML {
    ...
    public init(@HTMLBuilder content: () -> Content) where Caption == EmptyInlineContent {
        self.content = content()
        self.caption = EmptyInlineContent()
    }
    ...
    public init(
        ...
        @InlineContentBuilder caption: () -> Caption
    ) {
        self.content = content()

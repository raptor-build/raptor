...
extension UnitPoint {
    /// The x coordinate expressed as a percentage (0–100).
    var xPercentValue: LengthUnit { .percent(x * 100) }

    /// The y coordinate expressed as a percentage (0–100).
    var yPercentValue: LengthUnit { .percent(y * 100) }
}

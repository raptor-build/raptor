...
public enum HTMLBuilder {
    ...
    /// - Parameter content: The HTML element to convert
    /// - Returns: The same HTML element, unchanged
    public static func buildExpression<Content: InlineContent>(_ content: Content) -> some HTML {
        InlineHTML(content)
    }
    ...
    /// - Parameter content: The HTML element to pass through
    /// - Returns: The same HTML element
    public static func buildBlock<Content: InlineContent>(_ content: Content) -> some HTML {
        InlineHTML(content)
    }
    ...
    public static func buildEither<TrueContent, FalseContent>(
        first content: TrueContent
    ) -> ConditionalHTML<InlineHTML<TrueContent>, FalseContent> where TrueContent: InlineContent, FalseContent: HTML {
    ...
    public static func buildEither<TrueContent, FalseContent>(
        second content: FalseContent
    ) -> ConditionalHTML<TrueContent, InlineHTML<FalseContent>> where TrueContent: HTML, FalseContent: InlineContent {
